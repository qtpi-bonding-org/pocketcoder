			...
			if superusers != nil {
				...
				if suEmail != "" {
					...
					if existing == nil {
						...
						existing.Set("password", os.Getenv("POCKETBASE_SUPERUSER_PASSWORD"))
						app.Save(existing)
					}
				}
			}
			...
			if users != nil {
				...
				if adminEmail != "" {
					...
					if existing == nil {
						...
						existing.Set("password", os.Getenv("POCKETBASE_USER_PASSWORD"))
				...
				if agentEmail != "" {
					...
					if existing == nil {
						...
						existing.Set("password", os.Getenv("AGENT_PASSWORD"))
						existing.Set("role", "agent")
						app.Save(existing)
					}
				}
			}

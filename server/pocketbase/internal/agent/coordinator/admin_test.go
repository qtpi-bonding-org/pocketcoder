...
// TestAdminConnDialsAndInitializesWithoutCreatingASession is the
// Task 2 / Step 1 failing-test guard: AdminConn must dial, complete the
// initialize handshake, and stop — never call session/new.

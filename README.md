...
*(Original PocketCoder code — regenerated by `scripts/generate_audit.sh`; tests and generated code excluded.)*

| Language | LoC | Component |
| :--- | ---: | :--- |
| Go | 8,696 | c1: PocketBase + ACP client + AG-UI server |
| Rust | 769 | Sandbox proxy (dormant) |
| Dart | 47,306 | Flutter client (non-generated) |
| Bash | 5,160 | Shell scripts (infra — separate tally) |
| **CORE TOTAL** | **~56,771** | **Lean, Fast, Fully Sovereign.** |

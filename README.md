...
*(Original PocketCoder code — regenerated by `scripts/generate_audit.sh`; tests and generated code excluded. Dormant Rust — the sandbox proxy and `poco-agents` — lives in [`dormant/`](dormant/) and is excluded.)*

...
class SchedulesApi {
  ...
  Future<Response<ScheduleRunAcceptedResponse>> runScheduleNow({
    ...
    ScheduleRunAcceptedResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ScheduleRunAcceptedResponse),
      ) as ScheduleRunAcceptedResponse;
    ...
    return Response<ScheduleRunAcceptedResponse>(
      data: _responseData,

...
class AgentApi {
  ...
  Future<Response<AcceptedResponse>> promptChat({
    ...
    try {
      const _type = FullType(PromptRequest);
      _bodyData = _serializers.serialize(promptRequest, specifiedType: _type);
  ...
  Future<Response<void>> setChatConfigOption({
    ...
    try {
      const _type = FullType(ConfigOptionRequest);
      _bodyData = _serializers.serialize(configOptionRequest, specifiedType: _type);
  ...
  Future<Response<void>> setChatMode({
    ...
    try {
      const _type = FullType(ModeRequest);
      _bodyData = _serializers.serialize(modeRequest, specifiedType: _type);

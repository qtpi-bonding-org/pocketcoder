...
// `oauthRelayBaseUrl` getter exposed by the abstract class.
class _ConcreteExternalModule extends ExternalModule {}

void main() {
  test('oauthRelayBaseUrl points at the real deployed Worker', () {
    final module = _ConcreteExternalModule();
    expect(
      module.oauthRelayBaseUrl,
      'https://oauth.relay.pocketcoder.org',
    );
  });
}

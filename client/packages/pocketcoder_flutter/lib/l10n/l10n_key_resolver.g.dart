...
class L10nKeyResolver {
  ...
  String? resolve(String key, {Map<String, dynamic>? args}) {
    return switch (key) {
      ...
      'chat.run.outcome.interrupted.body' =>
        _l10n.chatRunOutcomeInterruptedBody,
      'chat.run.outcome.interrupted.title' =>
        _l10n.chatRunOutcomeInterruptedTitle,
      ...
      'credential.connection.open.authorization.page' =>
        _l10n.credentialConnectionOpenAuthorizationPage,
      'credential.connection.open.failed' =>
        _l10n.credentialConnectionOpenFailed,
      ...
      'deployment.config.not.ready.error' =>
        _l10n.deploymentConfigNotReadyError,
      ...
      'deployment.discard.attempt.cancel' =>
        _l10n.deploymentDiscardAttemptCancel,
      'deployment.discard.attempt.check.link' =>
        _l10n.deploymentDiscardAttemptCheckLink,
      'deployment.discard.attempt.confirm' =>
        _l10n.deploymentDiscardAttemptConfirm,
      'deployment.discard.attempt.confirm.checkbox' =>
        _l10n.deploymentDiscardAttemptConfirmCheckbox,
      ...
      'deployment.reset.also.clear.o.auth' =>
        _l10n.deploymentResetAlsoClearOAuth,
      ...
      'deployment.reset.confirmation.body' =>
        _l10n.deploymentResetConfirmationBody,
      'deployment.reset.confirmation.title' =>
        _l10n.deploymentResetConfirmationTitle,
      'deployment.reset.confirmation.warn.cloud' =>
        _l10n.deploymentResetConfirmationWarnCloud,
      ...
      'deployment.status.tls.rate.limited' =>
        _l10n.deploymentStatusTlsRateLimited,
      ...
      'deployment.step.final.instance.fetch' =>
        _l10n.deploymentStepFinalInstanceFetch,
      ...
      'foss.server.setup.public.key.label' =>
        _l10n.fossServerSetupPublicKeyLabel,
      ...
      'harness.auth.challenge.details.copied' =>
        _l10n.harnessAuthChallengeDetailsCopied,
      ...
      'initialization.instance.manifest' =>
        _l10n.initializationInstanceManifest,
      ...
      'initialization.metadata.registry' =>
        _l10n.initializationMetadataRegistry,
      ...
      'instance.gone.reset.confirmation.body' =>
        _l10n.instanceGoneResetConfirmationBody,
      'instance.gone.reset.confirmation.title' =>
        _l10n.instanceGoneResetConfirmationTitle,
      ...
      'instance.verification.check.failed.message' =>
        _l10n.instanceVerificationCheckFailedMessage,
      'instance.verification.reset.action' =>
        _l10n.instanceVerificationResetAction,
      'instance.verification.reset.cancel' =>
        _l10n.instanceVerificationResetCancel,
      'instance.verification.reset.confirm' =>
        _l10n.instanceVerificationResetConfirm,
      'instance.verification.reset.confirmation.body' =>
        _l10n.instanceVerificationResetConfirmationBody,
      'instance.verification.reset.confirmation.title' =>
        _l10n.instanceVerificationResetConfirmationTitle,
      ...
      'onboarding.choose.harness.loading.providers' =>
        _l10n.onboardingChooseHarnessLoadingProviders,
      ...
      'onboarding.harness.account.visibility.body' =>
        _l10n.onboardingHarnessAccountVisibilityBody,
      'onboarding.harness.account.visibility.cancel' =>
        _l10n.onboardingHarnessAccountVisibilityCancel,
      'onboarding.harness.account.visibility.personal' =>
        _l10n.onboardingHarnessAccountVisibilityPersonal,
      'onboarding.harness.account.visibility.shared' =>
        _l10n.onboardingHarnessAccountVisibilityShared,
      'onboarding.harness.account.visibility.title' =>
        _l10n.onboardingHarnessAccountVisibilityTitle,
      ...
      'onboarding.harness.providers.loading' =>
        _l10n.onboardingHarnessProvidersLoading,
      ...
      'onboarding.server.credentials.poco' =>
        _l10n.onboardingServerCredentialsPoco,
      'onboarding.server.credentials.title' =>
        _l10n.onboardingServerCredentialsTitle,
      ...
      'pocket.coder.update.available.status' =>
        _l10n.pocketCoderUpdateAvailableStatus,
      ...
      'pocket.coder.update.unknown.status' =>
        _l10n.pocketCoderUpdateUnknownStatus,
      ...
      'pocketbase.inspector.agent.profiles' =>
        _l10n.pocketbaseInspectorAgentProfiles,
      ...
      'pocketbase.inspector.no.chats.yet' =>
        _l10n.pocketbaseInspectorNoChatsYet,
      'pocketbase.inspector.recent.chats' =>
        _l10n.pocketbaseInspectorRecentChats,
      ...
      'pocketbase.inspector.unavailable' =>
        _l10n.pocketbaseInspectorUnavailable,
      ...
      'provider.reauthentication.required' =>
        _l10n.providerReauthenticationRequired,
      ...
      'provider.screen.delete.key.action' =>
        _l10n.providerScreenDeleteKeyAction,
      ...
      'provider.screen.search.no.matches' =>
        _l10n.providerScreenSearchNoMatches,
      ...
      'server.control.group.pocket.coder' =>
        _l10n.serverControlGroupPocketCoder,
      ...
      'server.control.operation.restart.nix.os' =>
        _l10n.serverControlOperationRestartNixOs,
      'server.control.operation.restart.pocket.coder' =>
        _l10n.serverControlOperationRestartPocketCoder,
      'server.control.operation.restore.backup' =>
        _l10n.serverControlOperationRestoreBackup,
      'server.control.operation.save.backup' =>
        _l10n.serverControlOperationSaveBackup,
      'server.control.operation.update.nix.os' =>
        _l10n.serverControlOperationUpdateNixOs,
      'server.control.operation.update.pocket.coder' =>
        _l10n.serverControlOperationUpdatePocketCoder,
      ...
      'server.control.provider.console.unavailable' =>
        _l10n.serverControlProviderConsoleUnavailable,
      ...
      'settings.delete.pro.data.confirm.body' =>
        _l10n.settingsDeleteProDataConfirmBody,
      'settings.delete.pro.data.confirm.title' =>
        _l10n.settingsDeleteProDataConfirmTitle,
      ...
      'settings.factory.reset.confirm.body' =>
        _l10n.settingsFactoryResetConfirmBody,
      'settings.factory.reset.confirm.title' =>
        _l10n.settingsFactoryResetConfirmTitle,
      ...
      'settings.menu.harness.connections' =>
        _l10n.settingsMenuHarnessConnections,
      ...
      'credential.connection.expires.at' => _l10n.credentialConnectionExpiresAt(
          args?['expiresAt'] as DateTime? ?? DateTime.now()),
      'deployment.admin.password.too.short' =>
        _l10n.deploymentAdminPasswordTooShort(args?['minLength'] as int? ?? 0),
      'deployment.discard.attempt.resource.id' =>
        _l10n.deploymentDiscardAttemptResourceId(
      ...
      'deployment.plan.poco' =>
        _l10n.deploymentPlanPoco(args?['minimumMemory'] as String? ?? ''),
      ...
      'external.auth.connecting' =>
        _l10n.externalAuthConnecting(args?['label'] as String? ?? ''),
      'foss.server.setup.error.prefix' =>
        _l10n.fossServerSetupErrorPrefix(args?['error'] as String? ?? ''),
      'harness.auth.account' => _l10n.harnessAuthAccount(
          args?['account'] as String? ?? '',
          args?['visibility'] as String? ?? ''),
      'harness.auth.api.key.configured' =>
        _l10n.harnessAuthApiKeyConfigured(args?['provider'] as String? ?? ''),
      'harness.auth.attempt' =>
        _l10n.harnessAuthAttempt(args?['id'] as String? ?? ''),
      'harness.auth.details' =>
        _l10n.harnessAuthDetails(args?['details'] as String? ?? ''),
      'harness.auth.mode' =>
        _l10n.harnessAuthMode(args?['mode'] as String? ?? ''),
      'harness.auth.provider.key.missing' =>
        _l10n.harnessAuthProviderKeyMissing(args?['harness'] as String? ?? ''),
      'harness.auth.status' =>
        _l10n.harnessAuthStatus(args?['status'] as String? ?? ''),
      'home.error.prefix' =>
        _l10n.homeErrorPrefix(args?['error'] as String? ?? ''),
      'initialization.copied.to.buffer' =>
        _l10n.initializationCopiedToBuffer(args?['label'] as String? ?? ''),
      'initialization.copy.label' =>
        _l10n.initializationCopyLabel(args?['label'] as String? ?? ''),
      'initialization.fault.detected' =>
        _l10n.initializationFaultDetected(args?['error'] as String? ?? ''),
      'initialization.fault.max.retries.exceeded' =>
        _l10n.initializationFaultMaxRetriesExceeded(
            args?['maxAttempts'] as String? ?? ''),
      'initialization.ready' =>
        _l10n.initializationReady(args?['ipAddress'] as String? ?? ''),
      'initialization.status.prefix' =>
        _l10n.initializationStatusPrefix(args?['status'] as String? ?? ''),
      'initialization.sync.attempt' =>
        _l10n.initializationSyncAttempt(args?['attempt'] as String? ?? ''),
      'instance.verification.check.action' => _l10n
          .instanceVerificationCheckAction(args?['provider'] as String? ?? ''),
      ...
      'memory.dashboard.account.summary' => _l10n.memoryDashboardAccountSummary(
          args?['observations'] as int? ?? 0,
          args?['interpretations'] as int? ?? 0),
      'memory.dashboard.linked.prefix' =>
        _l10n.memoryDashboardLinkedPrefix(args?['links'] as String? ?? ''),
      ...
      'onboarding.harness.account.login' =>
        _l10n.onboardingHarnessAccountLogin(args?['harness'] as String? ?? ''),
      ...
      'pocket.coder.update.data.boundary' =>
        _l10n.pocketCoderUpdateDataBoundary(
            args?['currentVersion'] as int? ?? 0,
            args?['availableVersion'] as int? ?? 0),
      'pocket.coder.update.failed' =>
        _l10n.pocketCoderUpdateFailed(args?['exitCode'] as int? ?? 0),
      'pocketbase.inspector.chat.archived.title' =>
        _l10n.pocketbaseInspectorChatArchivedTitle(
      ...
      'provider.screen.browse.all.models' =>
        _l10n.providerScreenBrowseAllModels(args?['count'] as int? ?? 0),
      'provider.screen.error.prefix' =>
        _l10n.providerScreenErrorPrefix(args?['error'] as String? ?? ''),
      'provider.screen.harness.model.count' =>
        _l10n.providerScreenHarnessModelCount(args?['count'] as int? ?? 0),
      'scheduler.edit.dialog.title' =>
        _l10n.schedulerEditDialogTitle(args?['name'] as String? ?? ''),
      'server.control.confirm.body' =>
        _l10n.serverControlConfirmBody(args?['operation'] as String? ?? ''),
      'server.control.error.prefix' =>
        _l10n.serverControlErrorPrefix(args?['error'] as String? ?? ''),
      'server.control.release.available' =>
        _l10n.serverControlReleaseAvailable(args?['version'] as String? ?? ''),
      'server.control.release.contracts' => _l10n.serverControlReleaseContracts(
          args?['app'] as String? ?? '',
          args?['server'] as String? ?? '',
          args?['deployment'] as String? ?? ''),
      'server.control.release.current' =>
        _l10n.serverControlReleaseCurrent(args?['version'] as String? ?? ''),
      'server.control.release.nixos' =>
        _l10n.serverControlReleaseNixos(args?['version'] as String? ?? ''),
      'server.control.release.status' =>
        _l10n.serverControlReleaseStatus(args?['status'] as String? ?? ''),
  ...
  static const arbToDotKey = <String, String>{
    ...
    'credentialConnectionOpenAuthorizationPage':
        'credential.connection.open.authorization.page',
    ...
    'deploymentDescriptionTlsRateLimited':
        'deployment.description.tls.rate.limited',
    ...
    'deploymentDiscardAttemptCheckLink':
        'deployment.discard.attempt.check.link',
    'deploymentDiscardAttemptConfirm': 'deployment.discard.attempt.confirm',
    'deploymentDiscardAttemptConfirmCheckbox':
        'deployment.discard.attempt.confirm.checkbox',
    'deploymentDiscardAttemptResourceId':
        'deployment.discard.attempt.resource.id',
    ...
    'deploymentDisconnectConfirmationBody':
        'deployment.disconnect.confirmation.body',
    'deploymentDisconnectConfirmationTitle':
        'deployment.disconnect.confirmation.title',
    'deploymentDistribution': 'deployment.distribution',
    'deploymentFaultDeploymentInstanceNotFound':
        'deployment.fault.deployment.instance.not.found',
    ...
    'deploymentResetConfirmationWarnCloud':
        'deployment.reset.confirmation.warn.cloud',
    ...
    'deploymentStepConfiguringOperatingSystem':
        'deployment.step.configuring.operating.system',
    'deploymentStepCreateFinalConfig': 'deployment.step.create.final.config',
    'deploymentStepCreateInstallerConfig':
        'deployment.step.create.installer.config',
    'deploymentStepCreateInstallerDisk':
        'deployment.step.create.installer.disk',
    ...
    'deploymentStepRemoveInstallerResources':
        'deployment.step.remove.installer.resources',
    'deploymentStepWaitInstallerCompletion':
        'deployment.step.wait.installer.completion',
    'deploymentStepWaitInstallerDiskReady':
        'deployment.step.wait.installer.disk.ready',
    'deploymentStepWaitTargetDiskReady':
        'deployment.step.wait.target.disk.ready',
    'deploymentStepWaitingForConnection':
        'deployment.step.waiting.for.connection',
    ...
    'harnessAuthChallengeDetailsCopied':
        'harness.auth.challenge.details.copied',
    ...
    'initializationConnectionParameters':
        'initialization.connection.parameters',
    ...
    'initializationDescriptionInitializing':
        'initialization.description.initializing',
    'initializationErrorCode': 'initialization.error.code',
    'initializationFailed': 'initialization.failed',
    'initializationFaultAuthenticationExpired':
        'initialization.fault.authentication.expired',
    'initializationFaultDetected': 'initialization.fault.detected',
    'initializationFaultGeneric': 'initialization.fault.generic',
    'initializationFaultMaxRetriesExceeded':
        'initialization.fault.max.retries.exceeded',
    'initializationFaultProvisionInterruptedNoResource':
        'initialization.fault.provision.interrupted.no.resource',
    'initializationFaultProvisionResourceNotFound':
        'initialization.fault.provision.resource.not.found',
    'initializationFaultProvisionResourceStillExists':
        'initialization.fault.provision.resource.still.exists',
    'initializationFaultResourceAlreadyExists':
        'initialization.fault.resource.already.exists',
    ...
    'initializationTechnicalDetailsToggle':
        'initialization.technical.details.toggle',
    ...
    'instanceGoneResetConfirmationBody':
        'instance.gone.reset.confirmation.body',
    'instanceGoneResetConfirmationTitle':
        'instance.gone.reset.confirmation.title',
    ...
    'instanceVerificationCheckFailedMessage':
        'instance.verification.check.failed.message',
    ...
    'instanceVerificationResetConfirmationBody':
        'instance.verification.reset.confirmation.body',
    'instanceVerificationResetConfirmationTitle':
        'instance.verification.reset.confirmation.title',
    ...
    'memoryDashboardNoInterpretationsYet':
        'memory.dashboard.no.interpretations.yet',
    ...
    'memoryDashboardRecentInterpretations':
        'memory.dashboard.recent.interpretations',
    ...
    'onboardingChooseHarnessLoadingProviders':
        'onboarding.choose.harness.loading.providers',
    ...
    'onboardingHarnessAccountVisibilityBody':
        'onboarding.harness.account.visibility.body',
    'onboardingHarnessAccountVisibilityCancel':
        'onboarding.harness.account.visibility.cancel',
    'onboardingHarnessAccountVisibilityPersonal':
        'onboarding.harness.account.visibility.personal',
    'onboardingHarnessAccountVisibilityShared':
        'onboarding.harness.account.visibility.shared',
    'onboardingHarnessAccountVisibilityTitle':
        'onboarding.harness.account.visibility.title',
    ...
    'pocketCoderUpdateReviewDataChange':
        'pocket.coder.update.review.data.change',
    ...
    'pocketbaseInspectorChatArchivedTitle':
        'pocketbase.inspector.chat.archived.title',
    ...
    'providerScreenApiKeyLeaveBlankHint':
        'provider.screen.api.key.leave.blank.hint',
    'providerScreenApiKeyNotSet': 'provider.screen.api.key.not.set',
    'providerScreenApiKeyStoredSecurely':
        'provider.screen.api.key.stored.securely',
    ...
    'serverControlOperationRestartNixOs':
        'server.control.operation.restart.nix.os',
    'serverControlOperationRestartPocketCoder':
        'server.control.operation.restart.pocket.coder',
    'serverControlOperationRestoreBackup':
        'server.control.operation.restore.backup',
    'serverControlOperationSaveBackup': 'server.control.operation.save.backup',
    'serverControlOperationUpdateNixOs':
        'server.control.operation.update.nix.os',
    'serverControlOperationUpdatePocketCoder':
        'server.control.operation.update.pocket.coder',
    ...
    'serverControlProviderConsoleUnavailable':
        'server.control.provider.console.unavailable',
    ...
    'settingsDeleteProDataConfirmTitle':
        'settings.delete.pro.data.confirm.title',
...
abstract class L10nKeys {
  ...
  static const chatRunOutcomeCancelledTitle =
      'chat.run.outcome.cancelled.title';
  ...
  static const chatRunOutcomeInterruptedBody =
      'chat.run.outcome.interrupted.body';
  static const chatRunOutcomeInterruptedTitle =
      'chat.run.outcome.interrupted.title';
  ...
  static const credentialConnectionEnterCode =
      'credential.connection.enter.code';
  static (String, Map<String, dynamic>) credentialConnectionExpiresAt(
          DateTime expiresAt) =>
      ('credential.connection.expires.at', {'expiresAt': expiresAt});
  static const credentialConnectionOpenAuthorizationPage =
      'credential.connection.open.authorization.page';
  static const credentialConnectionOpenFailed =
      'credential.connection.open.failed';
  static const credentialConnectionPasteCode =
      'credential.connection.paste.code';
  ...
  static (String, Map<String, dynamic>) deploymentAdminPasswordTooShort(
          int minLength) =>
      ('deployment.admin.password.too.short', {'minLength': minLength});
  ...
  static const deploymentConfigNotReadyError =
      'deployment.config.not.ready.error';
  ...
  static const deploymentDescriptionStarting =
      'deployment.description.starting';
  static const deploymentDescriptionTlsFailed =
      'deployment.description.tls.failed';
  static const deploymentDescriptionTlsRateLimited =
      'deployment.description.tls.rate.limited';
  static const deploymentDescriptionTlsReady =
      'deployment.description.tls.ready';
  static const deploymentDescriptionTlsZeroSsl =
      'deployment.description.tls.zero.ssl';
  static const deploymentDescriptionValidating =
      'deployment.description.validating';
  static const deploymentDiscardAttemptBody = 'deployment.discard.attempt.body';
  static const deploymentDiscardAttemptCancel =
      'deployment.discard.attempt.cancel';
  static const deploymentDiscardAttemptCheckLink =
      'deployment.discard.attempt.check.link';
  static const deploymentDiscardAttemptConfirm =
      'deployment.discard.attempt.confirm';
  static const deploymentDiscardAttemptConfirmCheckbox =
      'deployment.discard.attempt.confirm.checkbox';
  static (String, Map<String, dynamic>) deploymentDiscardAttemptResourceId(
          String resourceId) =>
      ('deployment.discard.attempt.resource.id', {'resourceId': resourceId});
  static const deploymentDiscardAttemptTitle =
      'deployment.discard.attempt.title';
  ...
  static const deploymentDisconnectConfirmationBody =
      'deployment.disconnect.confirmation.body';
  static const deploymentDisconnectConfirmationTitle =
      'deployment.disconnect.confirmation.title';
  static const deploymentDistribution = 'deployment.distribution';
  static const deploymentFaultDeploymentInstanceNotFound =
      'deployment.fault.deployment.instance.not.found';
  ...
  static (String, Map<String, dynamic>) deploymentPlanPoco(
          String minimumMemory) =>
      ('deployment.plan.poco', {'minimumMemory': minimumMemory});
  ...
  static const deploymentResetAlsoClearOAuth =
      'deployment.reset.also.clear.o.auth';
  ...
  static const deploymentResetConfirmationBody =
      'deployment.reset.confirmation.body';
  static const deploymentResetConfirmationTitle =
      'deployment.reset.confirmation.title';
  static const deploymentResetConfirmationWarnCloud =
      'deployment.reset.confirmation.warn.cloud';
  ...
  static const deploymentStatusTlsRateLimited =
      'deployment.status.tls.rate.limited';
  ...
  static const deploymentStepBootstrapComplete =
      'deployment.step.bootstrap.complete';
  static const deploymentStepComposeUp = 'deployment.step.compose.up';
  static const deploymentStepConfiguringOperatingSystem =
      'deployment.step.configuring.operating.system';
  static const deploymentStepCreateFinalConfig =
      'deployment.step.create.final.config';
  static const deploymentStepCreateInstallerConfig =
      'deployment.step.create.installer.config';
  static const deploymentStepCreateInstallerDisk =
      'deployment.step.create.installer.disk';
  static const deploymentStepCreateInstance = 'deployment.step.create.instance';
  static const deploymentStepCreateTargetDisk =
      'deployment.step.create.target.disk';
  static const deploymentStepEnableWatchdog = 'deployment.step.enable.watchdog';
  static const deploymentStepFetchingRelease =
      'deployment.step.fetching.release';
  static const deploymentStepFinalInstanceFetch =
      'deployment.step.final.instance.fetch';
  ...
  static const deploymentStepPreBootShutdown =
      'deployment.step.pre.boot.shutdown';
  static const deploymentStepReady = 'deployment.step.ready';
  static const deploymentStepRemoveInstallerResources =
      'deployment.step.remove.installer.resources';
  static const deploymentStepWaitInstallerCompletion =
      'deployment.step.wait.installer.completion';
  static const deploymentStepWaitInstallerDiskReady =
      'deployment.step.wait.installer.disk.ready';
  static const deploymentStepWaitTargetDiskReady =
      'deployment.step.wait.target.disk.ready';
  static const deploymentStepWaitingForConnection =
      'deployment.step.waiting.for.connection';
  ...
  static (String, Map<String, dynamic>) externalAuthConnecting(String label) =>
      ('external.auth.connecting', {'label': label});
  ...
  static (String, Map<String, dynamic>) fossServerSetupErrorPrefix(
          String error) =>
      ('foss.server.setup.error.prefix', {'error': error});
  ...
  static const fossServerSetupPublicKeyLabel =
      'foss.server.setup.public.key.label';
  ...
  static (String, Map<String, dynamic>) harnessAuthAccount(
          String account, String visibility) =>
      ('harness.auth.account', {'account': account, 'visibility': visibility});
  static const harnessAuthAccountLogin = 'harness.auth.account.login';
  static const harnessAuthApiKey = 'harness.auth.api.key';
  static (String, Map<String, dynamic>) harnessAuthApiKeyConfigured(
          String provider) =>
      ('harness.auth.api.key.configured', {'provider': provider});
  static (String, Map<String, dynamic>) harnessAuthAttempt(String id) =>
      ('harness.auth.attempt', {'id': id});
  static const harnessAuthCancel = 'harness.auth.cancel';
  static const harnessAuthChallenge = 'harness.auth.challenge';
  static const harnessAuthChallengeDetailsCopied =
      'harness.auth.challenge.details.copied';
  static const harnessAuthChallengeTargetCopied =
      'harness.auth.challenge.target.copied';
  static const harnessAuthChooseProviderKey =
      'harness.auth.choose.provider.key';
  static const harnessAuthConnections = 'harness.auth.connections';
  static const harnessAuthCopy = 'harness.auth.copy';
  static (String, Map<String, dynamic>) harnessAuthDetails(String details) =>
      ('harness.auth.details', {'details': details});
  ...
  static (String, Map<String, dynamic>) harnessAuthMode(String mode) =>
      ('harness.auth.mode', {'mode': mode});
  ...
  static (String, Map<String, dynamic>) harnessAuthProviderKeyMissing(
          String harness) =>
      ('harness.auth.provider.key.missing', {'harness': harness});
  static const harnessAuthRefresh = 'harness.auth.refresh';
  static const harnessAuthShared = 'harness.auth.shared';
  static (String, Map<String, dynamic>) harnessAuthStatus(String status) =>
      ('harness.auth.status', {'status': status});
  ...
  static const initializationConnectionParameters =
      'initialization.connection.parameters';
  static (String, Map<String, dynamic>) initializationCopiedToBuffer(
          String label) =>
      ('initialization.copied.to.buffer', {'label': label});
  static const initializationCopyAction = 'initialization.copy.action';
  static (String, Map<String, dynamic>) initializationCopyLabel(String label) =>
      ('initialization.copy.label', {'label': label});
  static const initializationCurrentOperation =
      'initialization.current.operation';
  static const initializationDescriptionInitializing =
      'initialization.description.initializing';
  static const initializationErrorCode = 'initialization.error.code';
  static const initializationFailed = 'initialization.failed';
  static const initializationFaultAuthenticationExpired =
      'initialization.fault.authentication.expired';
  static (String, Map<String, dynamic>) initializationFaultDetected(
          String error) =>
      ('initialization.fault.detected', {'error': error});
  static const initializationFaultGeneric = 'initialization.fault.generic';
  static (String, Map<String, dynamic>) initializationFaultMaxRetriesExceeded(
          String maxAttempts) =>
      (
        'initialization.fault.max.retries.exceeded',
        {'maxAttempts': maxAttempts}
      );
  static const initializationFaultProvisionInterruptedNoResource =
      'initialization.fault.provision.interrupted.no.resource';
  static const initializationFaultProvisionResourceNotFound =
      'initialization.fault.provision.resource.not.found';
  static const initializationFaultProvisionResourceStillExists =
      'initialization.fault.provision.resource.still.exists';
  static const initializationFaultResourceAlreadyExists =
      'initialization.fault.resource.already.exists';
  ...
  static const initializationInstanceManifest =
      'initialization.instance.manifest';
  ...
  static const initializationMetadataRegistry =
      'initialization.metadata.registry';
  ...
  static (String, Map<String, dynamic>) initializationReady(String ipAddress) =>
      ('initialization.ready', {'ipAddress': ipAddress});
  ...
  static const initializationStatusInitializing =
      'initialization.status.initializing';
  static (String, Map<String, dynamic>) initializationStatusPrefix(
          String status) =>
      ('initialization.status.prefix', {'status': status});
  static const initializationStatusSchema = 'initialization.status.schema';
  static (String, Map<String, dynamic>) initializationSyncAttempt(
          String attempt) =>
      ('initialization.sync.attempt', {'attempt': attempt});
  static const initializationTechnicalDetailsToggle =
      'initialization.technical.details.toggle';
  ...
  static const instanceGoneResetConfirmationBody =
      'instance.gone.reset.confirmation.body';
  static const instanceGoneResetConfirmationTitle =
      'instance.gone.reset.confirmation.title';
  static const instanceGoneTitle = 'instance.gone.title';
  static const instanceVerificationBody = 'instance.verification.body';
  static (String, Map<String, dynamic>) instanceVerificationCheckAction(
          String provider) =>
      ('instance.verification.check.action', {'provider': provider});
  static const instanceVerificationCheckFailedMessage =
      'instance.verification.check.failed.message';
  static const instanceVerificationResetAction =
      'instance.verification.reset.action';
  static const instanceVerificationResetCancel =
      'instance.verification.reset.cancel';
  static const instanceVerificationResetConfirm =
      'instance.verification.reset.confirm';
  static const instanceVerificationResetConfirmationBody =
      'instance.verification.reset.confirmation.body';
  static const instanceVerificationResetConfirmationTitle =
      'instance.verification.reset.confirmation.title';
  ...
  static (String, Map<String, dynamic>) memoryDashboardAccountSummary(
  ...
  static const memoryDashboardInterpretations =
      'memory.dashboard.interpretations';
  static (String, Map<String, dynamic>) memoryDashboardLinkedPrefix(
          String links) =>
      ('memory.dashboard.linked.prefix', {'links': links});
  static const memoryDashboardLinks = 'memory.dashboard.links';
  static const memoryDashboardNoInterpretationsYet =
      'memory.dashboard.no.interpretations.yet';
  static const memoryDashboardNoMemoryRecorded =
      'memory.dashboard.no.memory.recorded';
  static const memoryDashboardNoObservationsYet =
      'memory.dashboard.no.observations.yet';
  static const memoryDashboardObservations = 'memory.dashboard.observations';
  static const memoryDashboardRecentInterpretations =
      'memory.dashboard.recent.interpretations';
  static const memoryDashboardRecentObservations =
      'memory.dashboard.recent.observations';
  ...
  static const onboardingChooseHarnessLoadingProviders =
      'onboarding.choose.harness.loading.providers';
  ...
  static (String, Map<String, dynamic>) onboardingHarnessAccountLogin(
          String harness) =>
      ('onboarding.harness.account.login', {'harness': harness});
  static const onboardingHarnessAccountVisibilityBody =
      'onboarding.harness.account.visibility.body';
  static const onboardingHarnessAccountVisibilityCancel =
      'onboarding.harness.account.visibility.cancel';
  static const onboardingHarnessAccountVisibilityPersonal =
      'onboarding.harness.account.visibility.personal';
  static const onboardingHarnessAccountVisibilityShared =
      'onboarding.harness.account.visibility.shared';
  static const onboardingHarnessAccountVisibilityTitle =
      'onboarding.harness.account.visibility.title';
  ...
  static const onboardingHarnessProvidersLoading =
      'onboarding.harness.providers.loading';
  ...
  static const onboardingProviderAuthorizationAction =
      'onboarding.provider.authorization.action';
  ...
  static const onboardingServerCredentialsPoco =
      'onboarding.server.credentials.poco';
  static const onboardingServerCredentialsTitle =
      'onboarding.server.credentials.title';
  ...
  static const pocketCoderUpdateAvailableStatus =
      'pocket.coder.update.available.status';
  ...
  static const pocketCoderUpdateConfirmUpgrade =
      'pocket.coder.update.confirm.upgrade';
  static const pocketCoderUpdateCriticalStatus =
      'pocket.coder.update.critical.status';
  static const pocketCoderUpdateCurrent = 'pocket.coder.update.current';
  static const pocketCoderUpdateCurrentStatus =
      'pocket.coder.update.current.status';
  static (String, Map<String, dynamic>) pocketCoderUpdateDataBoundary(
  ...
  static (String, Map<String, dynamic>) pocketCoderUpdateFailed(int exitCode) =>
      ('pocket.coder.update.failed', {'exitCode': exitCode});
  static const pocketCoderUpdateNoDeployment =
      'pocket.coder.update.no.deployment';
  static const pocketCoderUpdateOutput = 'pocket.coder.update.output';
  static const pocketCoderUpdateRequiredDisk =
      'pocket.coder.update.required.disk';
  static const pocketCoderUpdateReviewDataChange =
      'pocket.coder.update.review.data.change';
  static const pocketCoderUpdateRollbackWarning =
      'pocket.coder.update.rollback.warning';
  ...
  static const pocketCoderUpdateUnknownStatus =
      'pocket.coder.update.unknown.status';
  ...
  static const pocketbaseInspectorAgentProfiles =
      'pocketbase.inspector.agent.profiles';
  static (String, Map<String, dynamic>) pocketbaseInspectorChatArchivedTitle(
          String title) =>
      ('pocketbase.inspector.chat.archived.title', {'title': title});
  ...
  static const pocketbaseInspectorMcpServers =
      'pocketbase.inspector.mcp.servers';
  static const pocketbaseInspectorNoChatsYet =
      'pocketbase.inspector.no.chats.yet';
  static const pocketbaseInspectorRecentChats =
      'pocketbase.inspector.recent.chats';
  ...
  static const pocketbaseInspectorUnavailable =
      'pocketbase.inspector.unavailable';
  ...
  static const providerReauthenticationRequired =
      'provider.reauthentication.required';
  ...
  static const providerScreenApiKeyLeaveBlankHint =
      'provider.screen.api.key.leave.blank.hint';
  static const providerScreenApiKeyNotSet = 'provider.screen.api.key.not.set';
  static const providerScreenApiKeyStoredSecurely =
      'provider.screen.api.key.stored.securely';
  static const providerScreenApiKeysSection =
      'provider.screen.api.keys.section';
  static (String, Map<String, dynamic>) providerScreenBrowseAllModels(
          int count) =>
      ('provider.screen.browse.all.models', {'count': count});
  static const providerScreenDefaultBadge = 'provider.screen.default.badge';
  static const providerScreenDeleteKeyAction =
      'provider.screen.delete.key.action';
  ...
  static (String, Map<String, dynamic>) providerScreenHarnessModelCount(
          int count) =>
      ('provider.screen.harness.model.count', {'count': count});
  ...
  static const providerScreenSearchNoMatches =
      'provider.screen.search.no.matches';
  ...
  static (String, Map<String, dynamic>) serverControlConfirmBody(
          String operation) =>
      ('server.control.confirm.body', {'operation': operation});
  ...
  static const serverControlConfirmRestoreBody =
      'server.control.confirm.restore.body';
  static const serverControlConfirmRestoreTitle =
      'server.control.confirm.restore.title';
  static const serverControlConfirmTitle = 'server.control.confirm.title';
  static const serverControlConnectionDetails =
      'server.control.connection.details';
  static const serverControlCopied = 'server.control.copied';
  static const serverControlCopy = 'server.control.copy';
  static (String, Map<String, dynamic>) serverControlErrorPrefix(
          String error) =>
      ('server.control.error.prefix', {'error': error});
  ...
  static const serverControlGroupPocketCoder =
      'server.control.group.pocket.coder';
  ...
  static const serverControlLocalAuthReason =
      'server.control.local.auth.reason';
  static const serverControlOperationRestartNixOs =
      'server.control.operation.restart.nix.os';
  static const serverControlOperationRestartPocketCoder =
      'server.control.operation.restart.pocket.coder';
  static const serverControlOperationRestoreBackup =
      'server.control.operation.restore.backup';
  static const serverControlOperationSaveBackup =
      'server.control.operation.save.backup';
  static const serverControlOperationUpdateNixOs =
      'server.control.operation.update.nix.os';
  static const serverControlOperationUpdatePocketCoder =
      'server.control.operation.update.pocket.coder';
  static const serverControlOutputLabel = 'server.control.output.label';
  static const serverControlPrivateKeyLabel =
      'server.control.private.key.label';
  static const serverControlProviderConsole = 'server.control.provider.console';
  static const serverControlProviderConsoleUnavailable =
      'server.control.provider.console.unavailable';
  static const serverControlPublicKeyLabel = 'server.control.public.key.label';
  static (String, Map<String, dynamic>) serverControlReleaseAvailable(
          String version) =>
      ('server.control.release.available', {'version': version});
  static const serverControlReleaseChecking = 'server.control.release.checking';
  static (String, Map<String, dynamic>) serverControlReleaseContracts(
          String app, String server, String deployment) =>
      (
        'server.control.release.contracts',
        {'app': app, 'server': server, 'deployment': deployment}
      );
  static (String, Map<String, dynamic>) serverControlReleaseCurrent(
          String version) =>
      ('server.control.release.current', {'version': version});
  static (String, Map<String, dynamic>) serverControlReleaseNixos(
          String version) =>
      ('server.control.release.nixos', {'version': version});
  static (String, Map<String, dynamic>) serverControlReleaseStatus(
          String status) =>
      ('server.control.release.status', {'status': status});
  ...
  static const settingsDeleteProDataConfirm =
      'settings.delete.pro.data.confirm';
  static const settingsDeleteProDataConfirmBody =
      'settings.delete.pro.data.confirm.body';
  static const settingsDeleteProDataConfirmTitle =
      'settings.delete.pro.data.confirm.title';
  ...
  static const settingsFactoryResetConfirmBody =
      'settings.factory.reset.confirm.body';
  static const settingsFactoryResetConfirmTitle =
      'settings.factory.reset.confirm.title';
  ...
  static const settingsMenuHarnessConnections =
      'settings.menu.harness.connections';
  ...
  static const settingsReportAiContentLabel =
      'settings.report.ai.content.label';
  ...
  static const toolPermissionsAddRuleButton =
      'tool.permissions.add.rule.button';

...
import 'package:pocketcoder_flutter/presentation/onboarding/widgets/choose_agent_view.dart';
import 'package:pocketcoder_flutter/support/onboarding_logger.dart';

class ChooseAgentAdapter extends CubitAdapter<ProviderCubit, ProviderState> {
  const ChooseAgentAdapter({super.key});
  ...
  Widget buildAdapter(
    ...
    return ValueListenableBuilder<UiFlowStatus>(
      ...
      builder: (context, status, _) => ValueListenableBuilder<List<Harnesse>>(
        ...
        builder: (context, harnesses, _) => ChooseAgentView(
          status: status,
          harnesses: harnesses,

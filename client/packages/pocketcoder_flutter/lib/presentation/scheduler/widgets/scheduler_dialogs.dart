...
void showEditScheduleDialog(
  ...
  Future<void> Function({required String id, required String displayName}) onRename,
  Future<void> Function({required String id, required String cron}) onUpdateCron,
) {
...
void showAddScheduleDialog(
  BuildContext context,
  Future<void> Function({required String displayName, required String cron, required String prompt}) onCreate,
) {

...
- Produces: `handleSkillsList(re *core.RequestEvent, app core.App, coord func() *coordinator.Coordinator) error` — the function `RegisterSkillsApi`'s `/skills/list` route (registered in Task 1) already calls.
              ...
              actions: [
                ...
                OutlinedButton(
                  onPressed: () {
                    ...
                    if (!isGlobal && selectedConfig == null) return;
                    final folders = isGlobal
                        ? null
                        : (selectedConfig!.workspaceFolders as List);
                    cubit.createSkill(
                      name: name,
                      description: description,
                      content: content,
                      global: isGlobal,
                      projectDir: isGlobal ? null : folders!.first as String,
                    );
                    Navigator.of(dialogContext).pop();
                  },
                  style: OutlinedButton.styleFrom(
